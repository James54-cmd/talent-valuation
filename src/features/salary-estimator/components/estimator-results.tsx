    ...
    <section className="animate-rise py-16 sm:py-20">
      <PageContainer className="space-y-10">
        ...
        <div className="grid gap-5 lg:grid-cols-[1.35fr_0.95fr]">
          <div className="rounded-[2rem] border border-border/60 bg-panel p-6 shadow-soft sm:p-8">
            <div className="flex flex-col justify-between gap-5 border-b border-border/60 pb-8 md:flex-row md:items-end">
              <div>
              ...
              <span className="inline-flex h-fit rounded-full bg-emerald-500/10 px-4 py-2 text-sm font-semibold text-emerald-700">
                {estimate.confidence}% confidence
              </span>
            </div>

            <div className="mt-7 rounded-full bg-background p-2">
            ...
            <div className="mt-8 grid gap-3 sm:grid-cols-3">
              {[
                ...
                <div
                  key={item.label}
                  className={cn(
                    "rounded-[1.5rem] border border-border/60 bg-background p-4 text-center",
          ...
          <div className="space-y-5">
            <div className="rounded-[2rem] border border-border/60 bg-panel p-6 shadow-soft">
                  ...
                  <div key={driver.label} className="grid grid-cols-[1fr_92px_42px] items-center gap-3">
                    ...
                    <div className="h-2 rounded-full bg-background">
                      <div
                        className={cn(
                          "h-2 rounded-full",
                          driver.tone === "primary" && "bg-primary",
                          driver.tone === "accent" && "bg-gold",
                          driver.tone === "muted" && "bg-foreground/20",
                        )}
            ...
            <div className="rounded-[2rem] bg-foreground p-6 text-background shadow-soft">
